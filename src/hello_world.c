...
GFont fontVerdanaBold42; // New Font
...
void handle_init(void) {
  ...
  // New Font:
	fontVerdanaBold42 = fonts_load_custom_font(resource_get_handle(RESOURCE_ID_FONT_VERDANA_BOLD_42));	
	// Create the Time Layer, set the font, and text alignment
	time_layer = text_layer_create(GRect(0, 5, 144, 168));
  text_layer_set_font(time_layer, fontVerdanaBold42); // New Font
...
void handle_deinit(void) {
  ...
  fonts_unload_custom_font(fontVerdanaBold42);
